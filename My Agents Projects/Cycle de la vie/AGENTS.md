...
Le workflow est :
- Le premier agent choisit aléatoirement un continent parmi tous les continents habités, sans privilégier systématiquement l'Afrique.
...
- Si la plante est comestible, il sélectionne exclusivement l'agent « Choix herbivore ». Celui-ci choisit aléatoirement un herbivore valide parmi plusieurs candidats, sans privilégier systématiquement l'éléphant. L'agent botaniste ne doit pas être sélectionné.
- L'agent suivant choisit aléatoirement un carnivore pouvant manger l'herbivore, sans privilégier systématiquement le lion. Puis il relance le choix de la plante et reboucle.
