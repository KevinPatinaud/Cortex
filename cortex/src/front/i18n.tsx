...
const fr = {
  ...
  "agent.continueTitle": "Lancer le prochain agent automatique",
  "agent.continueUnavailable": "Terminez cet agent avant de continuer",
...
const en: Record<TranslationKey, string> = {
  ...
  "sidebar.aria": "Project management", "sidebar.workspace": "Workspace", "sidebar.projects": "Projects", "sidebar.count": "{count} projects", "sidebar.hideList": "Hide project list", "sidebar.showList": "Show project list", "sidebar.hide": "Hide", "sidebar.change": "Change", "sidebar.editing": "Editing", "sidebar.activeProject": "Active project", "sidebar.newProject": "New project", "sidebar.opening": "Opening...", "sidebar.importing": "Importing...", "sidebar.import": "Import an existing project",
