...
const fr = {
  ...
  "project.created": "Le projet est prêt. Créez maintenant votre premier agent.",
  ...
  "creation.sharedInstructions": "Instructions partagées",
  "creation.previewAria": "Aperçu du projet",
  "creation.generatedStructure": "Structure générée",
  "creation.readyHelp": "Vous pourrez créer et composer les agents dès l’ouverture du projet.",
  "creation.creating": "Création...",
  "creation.create": "Créer le projet",
...
const en: Record<TranslationKey, string> = {
  ...
  "project.loadingList": "Loading projects...", "project.emptyList": "No projects saved yet.", "project.agentRunning": "An agent is running", "project.agentCompleted": "An agent has finished; result ready to review", "project.running": "Running", "project.review": "Review", "project.resetAria": "Reset {name} workflow", "project.deleteAria": "Delete {name}", "project.imported": "The project was added from its instruction file.", "project.deleted": "The project was deleted.", "project.reloaded": "The project files were reloaded.", "project.created": "The project is ready. Now create your first agent.", "project.resetTitle": "Reset the workflow?", "project.resetDescription": "You are about to reset the following workflow:", "project.reset": "Reset", "project.resetting": "Resetting...", "project.deleteTitle": "Delete this project?", "project.deleteDescription": "The project will be removed from Cortex. Its files will remain on disk and will not be deleted.", "project.deleting": "Deleting...",
  "dialog.confirmation": "Confirmation", "dialog.affectedProject": "Affected project",
  "creation.defaultInstructions": "# Project context\n\nDescribe the goals, constraints, and conventions to share with all agents.", "creation.eyebrow": "New workspace", "creation.title": "Create a Cortex project", "creation.description": "Cortex prepares the structure and files for the selected engine.", "creation.projectName": "Project name", "creation.defaultName": "new-project", "creation.parentDirectory": "Parent folder", "creation.parentHelp": "The project folder will be created here.", "creation.engine": "Agent engine", "creation.sharedInstructions": "Shared instructions", "creation.previewAria": "Project preview", "creation.generatedStructure": "Generated structure", "creation.readyHelp": "You can create and compose agents as soon as the project opens.", "creation.creating": "Creating...", "creation.create": "Create project",
