...
interface AgentEngineSettingsProps {
  projectId?: string;
}

export function AgentEngineSettings({ projectId }: AgentEngineSettingsProps) {
  ...
  const serverSettingsDisabled = isLoading || !hasLoadedSettings;
  ...
  async function updateConfiguration(
    ...
    if (serverSettingsDisabled || isSaving) return;
  ...
  async function updateProjectsDirectory(): Promise<void> {
    if (serverSettingsDisabled || isSavingProjectsDirectory) return;
    ...
    <div className="agent-engine-panel">
      ...
      >
        ...
        <div className="agent-settings-dialog__body agent-engine-settings__content">
          ...
          {hasLoadError && (
            <div className="agent-engine-settings__error">
              <p role="alert">{t("engine.settingsLoadError")}</p>
            ...
            <div className="agent-settings-dialog__section-content">
              ...
              <label>
                ...
                <input
                  ...
                  disabled={serverSettingsDisabled || isSaving}
              ...
              <label className="agent-engine-settings__danger-setting">
                ...
                <input
                  ...
                  disabled={serverSettingsDisabled || isSaving || !configuration.autopilot}
              ...
              <section className="agent-engine-storage" aria-labelledby="projects-storage-title">
                ...
                >
                  <input
                    ...
                    disabled={serverSettingsDisabled || isSavingProjectsDirectory}
                  />
                  <button
                    type="submit"
                    disabled={
